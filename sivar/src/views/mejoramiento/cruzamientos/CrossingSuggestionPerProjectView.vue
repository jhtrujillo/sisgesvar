    ...
    <div v-else class="bg-white border border-emerald-100 rounded-2xl shadow-xl p-8 max-w-4xl mx-auto my-8 animate-fade-in-up">
      <div class="flex flex-col items-center text-center">
        ...
        <div class="flex flex-col sm:flex-row items-center justify-center space-y-3 sm:space-y-0 sm:space-x-4">
          <button
            @click="exportarProgramacionExcel"
            class="w-full sm:w-auto px-6 py-3 text-sm font-bold text-white bg-sky-600 hover:bg-sky-700 rounded-xl shadow-md transition-all duration-200 flex items-center justify-center"
          >
            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
            </svg>
            Descargar Programación (Excel)
          </button>
...
async function autoOptimizarFlores(silent: boolean | Event = false) {
  ...
  for (let rowIndex = 0; rowIndex < rows.length; rowIndex++) {
    ...
    // 4. Asignación iterativa (Round-Robin) para maximizar uso de flores
