<template>
  <div class="space-y-8 w-full mx-auto px-4">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      <ModuleCardComponent
        title="Ver Cruzamientos"
        description="Consulte el catálogo histórico y el registro de cruzamientos exitosos programados."
      ...
      <ModuleCardComponent
        title="Programación"
        description="Planificación científica y ponderación de cruzamientos de acuerdo con viabilidad y mérito genético."
      ...
      <ModuleCardComponent
        title="Consolidado"
        description="Visualice alineamientos y resúmenes estadísticos consolidados de la campaña actual."
        actionText="Ver Consolidado"
