<template>
  <div class="space-y-8 w-full mx-auto px-4">
    <!-- Botón Volver -->
    ...
    <div class="border-b border-slate-100 pb-5">
      ...
      <p class="text-slate-500 mt-2 ml-11 text-sm">
        Planifique, consulte y realice el seguimiento de cruzamientos genéticos para el desarrollo de nuevas variedades.
      </p>
    </div>
      ...
      >
        ...
        <div class="flex flex-col h-full items-center text-center">
          ...
          <p class="text-slate-500 text-xs leading-relaxed mb-4">
            Planificación científica y ponderación de cruzamientos de acuerdo con viabilidad y mérito genético.
          </p>
