        ...
        <form @submit.prevent="runBlast" class="space-y-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
            ...
            <div>
              ...
              <select v-model="form.program" class="w-full border-slate-300 rounded-md shadow-sm focus:border-teal-500 focus:ring-teal-500 text-sm py-1.5" required>
            ...
            <div>
              ...
              <select v-model="form.database" class="w-full border-slate-300 rounded-md shadow-sm focus:border-teal-500 focus:ring-teal-500 text-sm py-1.5" required>
            ...
            <div class="md:col-span-2 mt-2">
              ...
              <input type="number" step="0.00001" v-model="form.expect" class="w-1/2 border-slate-300 rounded-md shadow-sm focus:border-teal-500 focus:ring-teal-500 text-sm py-1.5" placeholder="1e-5">
            </div>
          </div>
          ...
          <tbody>
            <template v-for="(hit, idx) in results.BlastOutput2[0].report.results.search.hits" :key="idx">
              <tr class="border-b border-slate-100 hover:bg-slate-50">
                ...
                <td class="py-3 px-4">{{ hit.hsps[0].identity }} / {{ hit.hsps[0].align_len }} ({{ Math.round((hit.hsps[0].identity / hit.hsps[0].align_len) * 100) }}%)</td>
