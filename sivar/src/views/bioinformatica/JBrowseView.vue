<!-- Vista para mostrar la herramienta embebida JBrowse-->
<template>
  <div class="flex flex-grow flex-col pt-5">
    ...
    <h1 class="text-center font-bold text-5xl mb-6 text-violet-800">{{ linksStore.linkList[2]?.name }}</h1>

    <iframe class="justify-center text-center" :src="linksStore.linkList[2]?.url" frameborder="0" width="100%" height="1000"></iframe>
  </div>
</template>
