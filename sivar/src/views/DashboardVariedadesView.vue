<template>
  <div class="space-y-8 w-full max-w-6xl mx-auto px-4">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      <ModuleCardComponent
        title="Floración"
        description="Seguimiento y registros históricos de estados de floración en los cultivos."
      ...
      <ModuleCardComponent
        title="Cruzamientos"
        description="Planificación y registro de nuevos cruzamientos y análisis de compatibilidad genotípica."
      ...
      <ModuleCardComponent
        title="Variedades"
        description="Gestión del catálogo varietal, genealogía e historial agronómico de selecciones."
      ...
      <ModuleCardComponent
        ...
        title="Experimentos"
        description="Diseño experimental, control de variables, parámetros ambientales e historial de ensayos."
      >
        <template #icon>
          <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24">
            <path
