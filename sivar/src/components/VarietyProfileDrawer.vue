<template>
  <Teleport to="body">
    <div class="relative z-[99999]">
      ...
      >
        <div v-if="isOpen" class="fixed inset-0 bg-slate-900/40 backdrop-blur-[3px] transition-opacity cursor-pointer" @click="closeDrawer"></div>
      </transition>

      <!-- Contenedor del Drawer Deslizante -->
      <div class="fixed inset-y-0 right-0 max-w-full flex pl-10" :class="isOpen ? 'pointer-events-auto' : 'pointer-events-none'">
        <transition
          ...
          <div v-if="isOpen" class="w-screen max-w-md">
            <div class="h-full flex flex-col bg-white/95 backdrop-blur-md shadow-2xl border-l border-slate-100 overflow-y-auto scrollbar-custom relative">
              ...
              <BaseButton
                ...
                size="xs"
                iconOnly
                class="!absolute top-4 right-4 z-50 !p-2 !rounded-xl text-slate-400 hover:text-slate-600 hover:bg-slate-50"
                @click="closeDrawer"
              >
              ...
              <div v-else class="flex-1 flex flex-col">
                ...
                <div class="bg-gradient-to-br from-cenicana-800 to-emerald-600 px-6 py-8 text-white relative overflow-hidden shadow-md">
                  ...
                  <BaseButton
                    ...
                    class="mb-3 !px-2.5 !py-1 !text-[10px] font-bold text-white !bg-white/10 hover:!bg-white/20 border border-white/20 backdrop-blur-sm"
                  >
                    <template #icon-left>
                  ...
                  <div class="flex items-center gap-3">
                    ...
                    <span
                      class="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-black bg-white/20 text-white border border-white/30 uppercase tracking-wider backdrop-blur-sm"
                    >
                ...
                <div class="p-6 space-y-6 flex-1">
                  ...
                  <div class="bg-slate-50/50 border border-slate-100 rounded-2xl p-4.5 space-y-3.5">
                    ...
                    <div class="bg-white border border-slate-200/60 rounded-xl p-3 shadow-sm">
                      ...
                      <span
                        class="text-xs font-mono font-bold text-slate-650 bg-slate-50/70 py-1.5 px-2 rounded-lg border border-slate-100 block tracking-tight overflow-x-auto"
                      >
                    ...
                    <h3 class="text-xs font-black text-slate-800 uppercase tracking-wider flex items-center gap-1.5 border-b border-slate-100 pb-2">
                      ...
                      >
                        <path
                          stroke-linecap="round"
                          stroke-linejoin="round"
                          d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10a2 2 0 01-2 2h-2a2 2 0 01-2-2zM9 19h6m-6 0l6-2m0 2V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"
                        />
                      </svg>
                    ...
                    <div class="space-y-4">
                      ...
                      <div class="space-y-1">
                        ...
                        <div class="relative w-full h-3.5 bg-slate-100 rounded-full overflow-hidden shadow-inner border border-slate-200/50">
                          ...
                          >
                            <span
                              class="absolute -top-3.5 -left-4 text-[8px] font-black text-rose-600 bg-rose-50 border border-rose-200/60 rounded px-1 scale-0 group-hover:scale-100 transition-transform shadow-sm"
                            >
                      ...
                      <div class="grid grid-cols-2 gap-3">
                        ...
                        <div class="border rounded-xl p-3 flex flex-col justify-between" :class="getDiseaseClass(profile.traits.roya_cafe_r)">
                          ...
                          <div class="flex items-center justify-between mt-1">
                            ...
                            <span class="text-[10px] font-bold px-1.5 py-0.5 rounded bg-white/40 border border-current/25"
                              >Escala: {{ formatScale(profile.traits.roya_cafe_r) }}</span
                            >
                          </div>
                        </div>
                        ...
                        <div class="border rounded-xl p-3 flex flex-col justify-between" :class="getDiseaseClass(profile.traits.roya_naranja_r)">
                          ...
                          <div class="flex items-center justify-between mt-1">
                            ...
                            <span class="text-[10px] font-bold px-1.5 py-0.5 rounded bg-white/40 border border-current/25"
                              >Escala: {{ formatScale(profile.traits.roya_naranja_r) }}</span
                            >
                          </div>
                        </div>
                        ...
                        <div class="border rounded-xl p-3 flex flex-col justify-between" :class="getDiseaseClass(profile.traits.mosaico_p)">
                          ...
                          <div class="flex items-center justify-between mt-1">
                            ...
                            <span class="text-[10px] font-bold px-1.5 py-0.5 rounded bg-white/40 border border-current/25"
                              >Escala: {{ formatScale(profile.traits.mosaico_p) }}</span
                            >
                          </div>
                        </div>
                        ...
                        <div class="border rounded-xl p-3 flex flex-col justify-between" :class="getDiseaseClass(profile.traits.carbon_p)">
                          ...
                          <div class="flex items-center justify-between mt-1">
                            ...
                            <span class="text-[10px] font-bold px-1.5 py-0.5 rounded bg-white/40 border border-current/25"
                              >Escala: {{ formatScale(profile.traits.carbon_p) }}</span
                            >
                          </div>
                        </div>
                      </div>
