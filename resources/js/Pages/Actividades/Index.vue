...
const filterAccion = ref(props.filters.accion || '');
const filterUserId = ref(props.filters.user_id || '');

const updateFilters = debounce(() => {
    router.get(route('actividades.index'), {
        search: search.value,
...
<template>
    <Head title="Historial & Auditoría" />
    ...
    <AuthenticatedLayout>
        ...
        <div class="py-8 bg-slate-50 min-h-screen">
            <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
                ...
                <div v-if="kpis" class="grid grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div class="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm flex items-center gap-4 hover:shadow-md transition duration-200 border-l-4 border-l-sky-500">
                    ...
                    <div class="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm flex items-center gap-4 hover:shadow-md transition duration-200 border-l-4 border-l-amber-500">
                    ...
                    <div class="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm flex items-center gap-4 hover:shadow-md transition duration-200 border-l-4 border-l-orange-500">
                ...
                <div class="relative">
                    ...
                    <div class="space-y-6">
                        <div 
                            ...
                            :key="act.id" 
                            class="relative pl-16 md:pl-20 flex flex-col transition duration-200 hover:-translate-x-0.5 group"
                        >
                            ...
                            <div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-5 flex flex-col space-y-3 group-hover:shadow-md group-hover:border-slate-300 transition">
